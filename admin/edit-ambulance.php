...
?>
                                    <div class="form-group ">
                                        <label for="adminname" class="control-label col-lg-3">نوع سيارة الاسعاف</label>
                                        <div class="col-lg-6">
                ...
                <?php } elseif($atype=="3"){ ?>
                   ...
                   <?php }?>
                                    ...
                                    <div class="form-group ">
                                        <label for="adminname" class="control-label col-lg-3">رقم اللوحة</label>
                                        <div class="col-lg-6">
                                    ...
                                    <div class="form-group ">
                                        <label for="adminname" class="control-label col-lg-3">اسم السائق</label>
                                        <div class="col-lg-6">
                                     ...
                                     <div class="form-group ">
                                        <label for="adminname" class="control-label col-lg-3">رقم السائق</label>
                                        <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-3 col-lg-6">
                                          <p style="text-align: center;"> <button class="btn btn-primary" type="submit" name="submit">تــعـــديل</button></p>
